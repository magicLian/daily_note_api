...
func (j *Json) ContainsKey(key string) (bool, error) {
	m, err := j.Map()
	if err != nil {
		return false, err
	}
...
func (j *Json) MustArray(args ...[]interface{}) []interface{} {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustArray() received too many arguments %d", len(args))
	}
...
func (j *Json) MustMap(args ...map[string]interface{}) map[string]interface{} {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustMap() received too many arguments %d", len(args))
	}
...
func (j *Json) MustString(args ...string) string {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustString() received too many arguments %d", len(args))
	}
...
func (j *Json) MustStringArray(args ...[]string) []string {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustStringArray() received too many arguments %d", len(args))
	}
...
func (j *Json) MustInt(args ...int) int {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustInt() received too many arguments %d", len(args))
	}
...
func (j *Json) MustFloat64(args ...float64) float64 {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustFloat64() received too many arguments %d", len(args))
	}
...
func (j *Json) MustBool(args ...bool) bool {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustBool() received too many arguments %d", len(args))
	}
...
func (j *Json) MustInt64(args ...int64) int64 {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustInt64() received too many arguments %d", len(args))
	}
...
func (j *Json) MustUint64(args ...uint64) uint64 {
	...
	case 1:
		def = args[0]
	default:
		log.Errorf("MustUint64() received too many arguments %d", len(args))
	}
